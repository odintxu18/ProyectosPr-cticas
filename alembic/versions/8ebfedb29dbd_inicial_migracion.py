...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['id_ganador'], ['jugadores.id'], ),
    sa.ForeignKeyConstraint(['id_jugador_o'], ['jugadores.id'], ),
    sa.ForeignKeyConstraint(['id_jugador_x'], ['jugadores.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['id_partida'], ['partidas.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
